...
df = pd.read_csv('D:\\УЧЕБА_УРФУ\\Программирование\\4_семестр\\Проект\\dlya_modeli.csv')
model = joblib.load('D:\\УЧЕБА_УРФУ\\Программирование\\4_семестр\\Проект\\model_1.pkl')
